    ...
    <div className="space-y-6 pb-20 md:pb-6 animate-in fade-in duration-500">
      <header className="flex flex-col gap-2">
        ...
        <p className="text-slate-500 dark:text-slate-400">
          Here is a quick summary of your tasks and goals today.
        </p>
      </header>
      ...
      <section className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-sm border border-slate-100 dark:border-slate-800 flex gap-4 items-center">
        ...
        />
        <Button size="sm" className="whitespace-nowrap w-fit rounded-full px-6">Save</Button>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-800 flex items-center gap-6 col-span-1 md:col-span-2">
          ...
          <div className="space-y-1">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm">You have completed 3 out of 5 tasks today.</p>
            <p className="text-xs text-primary-600 dark:text-primary-400 font-medium pt-1">+ 45 minutes of focused work</p>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl p-6 shadow-md text-white flex flex-col justify-center items-center gap-2">
          ...
          <h3 className="font-bold text-2xl font-mono">12 <span className="text-base font-normal">days</span></h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <section className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-800 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 px-2 py-1 rounded-full font-medium">1 Overdue</span>
          </div>
            ...
            {[1, 2, 3].map(i => (
              <div key={i} className="py-3 flex items-start gap-3 group">
                ...
                <div className="flex-1 space-y-1">
                  <p className="text-sm font-medium group-hover:text-primary-600 transition-colors">Review recent code update ({i})</p>
            ...
            {[1, 2].map(i => (
              <div key={i} className="space-y-2">
                <div className="flex justify-between items-center text-sm">
                  <span className="font-medium">Learn English</span>
